...
from .Joy_caption_alpha import Joy_caption_alpha_load,Joy_caption_alpha_run,Joy_caption_alpha_prompt,Joy_caption_alpha_batch,Joy_caption_alpha_batches, Joy_caption_alpha_batch_Dirs
...
NODE_CLASS_MAPPINGS = {
    ...
    "Joy_caption_alpha_batches":Joy_caption_alpha_batches,
